    ...
    public class AuctionViewModelMappings
    {
        public static void Setup()
        {
            Mapper.CreateMap<Auction, AuctionViewModel>()
                .ForMember(dst => dst.FriendlyCreatedAt, opt => opt.MapFrom(src => src.CreatedAt.ToFriendlyString()))
                .ForMember(dst => dst.FriendlyStartedAt, opt => opt.MapFrom(src => src.StartedAt.ToFriendlyString()))
                .ForMember(dst => dst.FriendlyEndedAt, opt => opt.MapFrom(src => src.EndedAt.ToFriendlyString()));
        }
    }
}